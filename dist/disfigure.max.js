...
import { TextureNode, DataTexture, RGBAFormat, FloatType, Vector3, Vector4, PlaneGeometry, Scene, InstancedMesh, MeshStandardNodeMaterial, InstancedBufferAttribute, Color, Quaternion, Object3D, MathUtils, Euler, WebGPURenderer, PCFSoftShadowMap, PerspectiveCamera, DirectionalLight, Mesh, CircleGeometry, MeshLambertMaterial, CanvasTexture } from 'three';
import { Fn, ivec2, uniformArray, vec4, If, select, mat3, positionGeometry, normalGeometry, vec3, attribute, int, step, Loop, transformNormalToView, vertexStage, mix, vec2, float, rotate } from 'three/tsl';
