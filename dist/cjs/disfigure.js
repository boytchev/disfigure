...
function selectFootLeft( { footLeftSpan, ankle } ) {
	...
	return tsl.positionGeometry.z.smoothstep( footLeftSpan.x, footLeftSpan.y ).mul( tsl.positionGeometry.y.step( ankle.max ) );
...
function selectFootRight( { footRightSpan, ankle } ) {
	...
	return tsl.positionGeometry.z.smoothstep( footRightSpan.x, footRightSpan.y ).mul( tsl.positionGeometry.y.step( ankle.max ) );
...
exports.HorizontalLocus = HorizontalLocus;
