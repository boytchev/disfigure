...
import { Fn, mat3, uniform, mix, float, If, select, vec3, positionGeometry, normalGeometry, transformNormalToView } from 'three/tsl';
...
function tslNormalNode( options ) {
	...
	return transformNormalToView( tslPositionNode2( options ) ).normalize( );

}



var tslPositionNode2 = Fn( ( { skeleton, posture, mode, vertex } )=>{
